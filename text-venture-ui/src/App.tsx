      ...
      scenes: [
        {
          ...
          description: [
            ...
            "On the left the {scene:alien-saloon:Alien Saloon} emitted a captivating blend of otherworldly music and lively chatter, enticing passersby with its mysterious melodies.",
          ...
          interactions: [
            {
              type: "walk-to",
              id: "walk-to-alien-saloon",
              matchesAction: {
                oneOf: "walkTo",
              },
              matchesObjects: [
                {
                  oneIdOf: "alien-saloon",
                },
              ],
              responses: [
                "Captain Hunter stepped onto Dry Water's main street and breathed in the air of opportunity, muttering to himself, 'Ah, the beating heart of frontier trade. Time to wheel and deal, my friend. Let's see what fortunes this dusty town holds for us today.'",
              ],
            },
            {
              type: "walk-to",
        ...
        },
        {
          type: "scene",
          id: "alien-saloon",
          name: "The Alien Saloon",
          description: [
            "From the bustling main street of Dry Water, one's gaze befalls the alien saloon—an exotic haven clad in rustic grandeur. Its vibrant facade, adorned with ethereal symbols, emanates otherworldly melodies that beckon travelers to indulge in the intoxicating blend of mystery and revelry within.",
            ...
            "As the night wore on, {player:captain-hunter:Captain Hunter} and {player:ames:Ames} found themselves immersed in the enchanting atmosphere of the alien saloon. They danced with outlaws, shared stories with extraterrestrial beings, and reveled in the harmonies that transcended language and culture.",
            "Little did they know, their presence in this peculiar establishment would set in motion a chain of events that would shape their destiny and lead them further into the uncharted depths of the universe.",
        ...
        },
        {
          ...
          description: [
            ...
            "Little did they know, their journey through the desert would be the catalyst for new alliances, uncharted discoveries, and the realization that even in the harshest of environments, the human spirit can prevail against all odds.",
